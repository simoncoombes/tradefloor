...
DIAL_PROVENANCE: dict[str, dict[str, Any]] = {
    ...
    "vix_ceiling": {
        ...
        "source": "programme/results/b4fix6-registration.md section 2 "
                  ...
                  "a silent RNG -- and as of 2026-09-14 all three are RED "
                  "on pt-v19. The first two open with "
                  "`assert_eq!(vix_return_gain, vix_return_gain_up)`, "
                  "8.83 against 0.049, which the two-law response makes "
                  "permanently false; the third fails on the withdrawn "
                  "ordering. The module was written for a one-law "
                  "response and has not been rewritten for the composed "
                  "vector",
        "clip_rate": {
    ...
    "vix_target_shock_cap": {
        ...
        "source": "rust/src/params.rs, ModelParams::vix_target_shock_cap, "
                  ...
                  "and as of 2026-09-14 it is RED on the shipped preset: "
                  "`the_default_cap_is_the_clamps_own_image` compares the "
                  "cap against the level-blind spelling `gain * clamp ** p` "
                  "= 445.9577 and asserts `vix_return_exponent == 1.0`. Five "
                  "of the module's six tests fail on pt-v19 for the same "
                  "reason: they were written for a one-law response",
