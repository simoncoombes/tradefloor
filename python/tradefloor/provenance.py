...
OUT_OF_SCOPE = {
    ...
    "crisis_epicentre_extra":
        ...
        "market/factors.rs takes the `None` arm of both matches -- so the "
        "sector leg and the idiosyncratic draw are the expressions that stood "
        "there before the mechanism existed, not those expressions times one. "
        ...
        "parts of their return that are NOT the market factor. The value is "
        ...
        "THE APPLIED MULTIPLE IS NOT THIS NUMBER: the dial is stated on a "
        "name's TOTAL volatility and the market component is untouched, so "
        "market/factors.rs `crisis_epicentre_gain` solves "
        "`g = sqrt((e^2 - m) / (1 - m))` with `m` the market factor's MEASURED "
        "share of a name's daily return variance, 0.3916 under a held VIX of "
        "65 on the composed pt-v19 and 0.3225 free-running (three seeds of the "
        "held roster, 252 sessions, numerator the day's accumulated market "
        "part of `random_noise`, denominator the realised daily log return): "
        "`g^2 = (3.7249 - 0.3916) / 0.6084 = 5.4789`, `g = 2.3407`. Shipped at "
