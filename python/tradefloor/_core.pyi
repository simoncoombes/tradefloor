...
class Engine:
    ...
    def run_days(
        ...
        record: bool = ..., first_day: int = ..., ledger: Any | None = ...,
    ) -> int: ...
    def run_until(
    ...
    # day, tick, instrument_id, print, model_price, shock, absorbed, and --
    # only when `settle_depth_counterfactual(True)` ran before the session --
    # unbounded_print and liquidity_share. The schema metadata says which of
