...
impl PyEngine {
    ...
    fn state_snapshot(&self, py: Python<'_>) -> PyResult<Py<PyDict>> {
        ...
        econ_put!(
            ...
            vix_selfex_fear, vix_selfex_excitation,
            vix_har_rv_week, vix_har_rv_month,
            vix_selfex_vol_kick, vix_selfex_ruler,
            vix_selfex_kick_pending, vix_selfex_kick_points, vix_selfex_kick_vix_ref,
