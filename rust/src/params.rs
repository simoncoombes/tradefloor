...
impl ModelParams {
    ...
    /// Look a shipped preset up by name. `"pt-v1"` is the only entry today;
    /// a calibrated `pt-v2` joins this table on adoption and `pt-v1` stays
...
mod tests {
    ...
    fn the_shipped_preset_fingerprints_as_its_own_name() {
        ...
        assert!(ModelParams::preset("pt-v2").is_none());
    }
