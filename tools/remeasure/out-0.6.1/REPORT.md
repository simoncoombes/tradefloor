...
Commit `79f977d`, 2026-08-31 14:38, pretium 0.6.1. Full run: 285s wall with 64 workers.
...
|---|---|---|---|
| docs/model-presets.md:92 | a nudged garch_alpha fingerprints as custom-7f290e34, never pt-v1 | custom-7f290e34 | custom-9f6e67b6 |
| docs/strategy-specs.md:156 | ...to +9.79% at six... | 9.79 | 6.07 |
| docs/core-concepts.md:62 | vix takes a new value every day: 120 distinct values in 120 days | 118 | 120 |
| docs/core-concepts.md:81 | pinning federal_funds_rate alone repriced none of the twenty | 0 | 19 |
| docs/forking-a-simulation.md:22 | pt.branch cost < 1 ms | 1 | 5.053 |
| docs/forking-a-simulation.md:26 | Checkpoint replay is three orders of magnitude slower than branch | 3 | 1.737 |
| docs/scenarios.md:30 | buy_and_hold calm return | -6.08 | -8.97 |
| docs/scenarios.md:30 | buy_and_hold hiked return | -8.64 | -12.4 |
| docs/scenarios.md:30 | buy_and_hold delta | -2.56 | -3.433 |
| docs/scenarios.md:31 | momentum calm return | -5.64 | -6.071 |
| docs/scenarios.md:31 | momentum hiked return | -7.51 | -10.4 |
| docs/scenarios.md:31 | momentum delta | -1.87 | -4.324 |
| docs/scenarios.md:32 | oracle calm return | 13.22 | 12.01 |
| docs/scenarios.md:32 | oracle hiked return | 11.11 | 9.382 |
| docs/scenarios.md:32 | oracle delta | -2.11 | -2.628 |
| docs/scenarios.md:40 | across sim seeds 5 to 9 buy-and-hold gives up 3.4 to 4.7 points (delta -4.7...) | -3.9 | -3.709 |
| docs/scenarios.md:40 | ...to -3.4 | -2.6 | -3.313 |
| docs/scenarios.md:41 | momentum's give-up spans -5.1... | -1.9 | -4.33 |
| docs/scenarios.md:41 | ...to +0.5 | 1.2 | 1.079 |
| docs/scenarios.md:41 | pinning federal_funds_rate alone: exactly 0.00% across twenty instruments over 40 days | 0 | 4.094 |
| docs/scenarios.md:47 | a 60-day run crossing the day-45 central-bank meeting reprices a median -4.29% | -4 | -5.685 |
| docs/scenarios.md:156 | annualised realised vol at VIX 5 | 30.29 | 24.04 |
| docs/scenarios.md:157 | annualised realised vol at VIX 15 | 36.71 | 28.35 |
| docs/scenarios.md:158 | annualised realised vol at VIX 45 | 112.1 | 83.66 |
| docs/scenarios.md:159 | annualised realised vol at VIX 65 | 135.5 | 119.4 |
| docs/scenarios.md:161 | a thirteenfold move in VIX moves realised volatility by a factor of 2.5 | 4.5 | 4.968 |
| docs/scenarios.md:188 | mean quoted spread at VIX 15 | 11.78 | 11.85 |
| docs/scenarios.md:188 | mean quoted spread at VIX 25 | 14.14 | 14.33 |
| docs/scenarios.md:188 | mean quoted spread at VIX 45 | 17.49 | 19.61 |
| docs/scenarios.md:189 | mean quoted spread at VIX 65 | 22.62 | 27.19 |
| docs/scenarios.md:195 | mean pairwise correlation at VIX 15, 300 pairs | 0.197 | 0.2905 |
| docs/scenarios.md:195 | mean pairwise correlation at VIX 45 | 0.626 | 0.5992 |
| docs/scenarios.md:195 | mean pairwise correlation at VIX 65 | 0.678 | 0.6623 |
| docs/rng-streams.md:37 | the era's later model changes have since taken the known-answer version to 11 | 11 | 13 |
| docs/agents-and-evaluation.md:50 | buy_and_hold beats the Oracle 1 of 12 | 1 | 0 |
| docs/agents-and-evaluation.md:143 | mean-reversion's one win is barely above 1.0: capture 1.004 | 1.52 | 1.677 |
| docs/agents-and-evaluation.md:109 | buy-and-hold's one win is capture 1.59... | 1.02 | nan |
| docs/agents-and-evaluation.md:96 | Oracle median P&L on the ranking grid at ten days, sim seeds 0-7, default top_k=5: $93k | 60,000 | 70,130 |
| docs/agents-and-evaluation.md:96 | the same information across three times as many names, top_k=15: $65k | 48,100 | 54,641 |
| docs/agents-and-evaluation.md:102 | the Oracle makes $85k in five days on seed 2026 over random(40,7) | 77,400 | 92,370 |
| docs/agents-and-evaluation.md:103 | momentum's capture ratio against the five-day denominator: 0.40 | 0.066 | 0.3619 |
| docs/agents-and-evaluation.md:104 | and 1.24 against the sixty-day one - the horizon alone carries the verdict across 1.0 | 1.18 | 1.334 |
| docs/agents-and-evaluation.md:120 | over twelve markets momentum ranks +0.593 pooled | 0.259 | 0.01828 |
| docs/agents-and-evaluation.md:143 | mean-reversion +0.160 | 0.783 | 0.9925 |
| docs/agents-and-evaluation.md:121 | a single seed picks the pooled leader only five times in twelve | 3 | 0 |
| docs/agents-and-evaluation.md:121 | and equally often crowns mean-reversion: 5 of 12 | 8 | 12 |
| docs/agents-and-evaluation.md:124 | momentum capture range, low: +0.089 | -0.503 | -0.4627 |
| docs/agents-and-evaluation.md:124 | momentum capture range, high: +1.523 | 0.909 | 0.5594 |
| docs/agents-and-evaluation.md:133 | momentum vs mean_reversion: 7-5 | 9-3 | 12-0 |
| docs/agents-and-evaluation.md:133 | p = 0.77 | 0.15 | 0.000488 |
| docs/agents-and-evaluation.md:170 | the identical test over seeds 12-23: momentum over mean-reversion 9-3 | 10-2 | 11-1 |
| docs/agents-and-evaluation.md:170 | p = 0.15 | 0.04 | 0.006348 |
| docs/agents-and-evaluation.md:181 | three days, seeds 0-9: the reference's per-seed P&L spans $11.2k... | 13,700 | 15,969 |
| docs/agents-and-evaluation.md:182 | mean-reversion's ratio on the thinnest of those markets: +1.29 | 1.57 | 2.077 |
| docs/agents-and-evaluation.md:182 | against a pooled +0.44 across the ten | 0.78 | 0.7118 |
| docs/agents-and-evaluation.md:128 | three of the four ratios above 1.0 sit on the four thinnest denominators | 3 | 1 |
| docs/agents-and-evaluation.md:187 | averaging the ten ratios instead of pooling them would move the verdict to +0.61 | 0.88 | 0.7824 |
| docs/an-llm-agent.md:30 | oracle pnl 229751 | 155,707 | 173,306 |
| docs/an-llm-agent.md:32 | momentum pnl 21520 | -2,207 | -32,064 |
| docs/an-llm-agent.md:63 | oracle twenty-day impact spans -235... | -451.1 | -421.6 |
| docs/an-llm-agent.md:63 | ...to +470 bps across seeds 2020-2031 | 418.4 | 559.1 |
| docs/an-llm-agent.md:60 | positive in only 7 of 12 seeds | 5 | 6 |
| docs/an-llm-agent.md:52 | over two days both agents are positive in 12 of 12 | 12 | 11 |
| docs/an-llm-agent.md:60 | by day three the oracle's sign already belongs to the seed: positive in 8 of 12 | 11 | 12 |
| docs/reproducing-a-run.md:36 | pt.version() == '0.1.0' | 0.3.0 | 0.6.1 |
| docs/reproducing-a-run.md:37 | model_preset()['name'] == 'pt-v1' | pt-v12 | pt-v16 |
| docs/reproducing-a-run.md:215 | the digest the five targets reported at f722ce3, printed in full | 60d475726c8b270df0894da7577523e98d044dd09afc6b536377eaf4b40de590 | 74f451bb1e3372ca032f57b9546ddf40a51e08c8fc7dab82a17e73a3d7749f39 |
| docs/reproducing-a-run.md:212 | 'the identical known-answer v11 digest' - the era named as current | 11 | 13 |
| docs/sharing-a-run.md:91 | pt.version() stayed '0.1.0' across the era boundary | 0.3.0 | 0.6.1 |
| docs/transaction-cost-analysis.md:33 | the round trip ends anywhere between -17.72... | -17.72 | -25.71 |
| docs/transaction-cost-analysis.md:34 | ...and +2.03 bps | 2.03 | -4.76 |
| docs/transaction-cost-analysis.md:34 | negative on seven of the eight | 7 | 8 |
| docs/transaction-cost-analysis.md:65 | the agent traded 57 names | 57 | 50 |
| docs/transaction-cost-analysis.md:65 | leaving three untouched | 3 | 10 |
| docs/transaction-cost-analysis.md:65 | all three it never touched moved | 3 | 5 |
| docs/transaction-cost-analysis.md:66 | by -10.72... | -10.72 | -13.24 |
| docs/transaction-cost-analysis.md:66 | ...+2.00 and +1.97 bps | 2 | 6.146 |
| docs/transaction-cost-analysis.md:66 | the third leaked name: +1.97 bps | 1.97 | 2.882 |
| docs/transaction-cost-analysis.md:66 | against a 9.71 bps median direct impact on the traded names | 9.71 | 9.851 |
| docs/transaction-cost-analysis.md:81 | nothing leaks at one or two days; nine untouched names leak at three | 9 | 7 |
| docs/transaction-cost-analysis.md:82 | at four days eighteen untouched names move | 18 | 11 |
| docs/strategy-specs.md:156 | the rebalance measurement swings the same one-day signal from +37.55% at three decisions a day... | 37.55 | 40.38 |
| docs/strategy-specs.md:156 | ...to -27.46% at twelve, purely by trading it more often | -27.46 | -29.1 |
...
|---|---|---|---|---|---|
| 76 | nine factor columns sum to the move, residual around 1e-16 | 1e-16 | 1.49e-17 | - | reproduced |
| 183 | the examples are executed by the test suite; the worked example asserts its own findings | True | True | - | structural_ok |
| 199 | worked example: the whole study takes about five seconds | 5 | 6.969 | 1.969 | machine_bound |
...
| 50 | buy_and_hold beats the Oracle 1 of 12 | 1 | 0 | -1 | MOVED |
...
| 96 | Oracle median P&L on the ranking grid at ten days, sim seeds 0-7, default top_k=5: $93k | 60,000 | 70,130 | 10,130 | MOVED |
| 96 | the same information across three times as many names, top_k=15: $65k | 48,100 | 54,641 | 6,541 | MOVED |
| 102 | the Oracle makes $85k in five days on seed 2026 over random(40,7) | 77,400 | 92,370 | 14,970 | MOVED |
...
| 103 | momentum's capture ratio against the five-day denominator: 0.40 | 0.066 | 0.3619 | 0.2959 | MOVED |
| 104 | and 1.24 against the sixty-day one - the horizon alone carries the verdict across 1.0 | 1.18 | 1.334 | 0.1536 | MOVED |
| 109 | buy-and-hold's one win is capture 1.59... | 1.02 | nan | nan | MOVED |
| 113 | even a clean sweep only reaches p = 0.0005 | 0.0005 | 0.000488 | -1.17e-05 | reproduced |
| 120 | over twelve markets momentum ranks +0.593 pooled | 0.259 | 0.01828 | -0.2407 | MOVED |
| 121 | and equally often crowns mean-reversion: 5 of 12 | 8 | 12 | 4 | MOVED |
| 121 | a single seed picks the pooled leader only five times in twelve | 3 | 0 | -3 | MOVED |
| 124 | momentum capture range, high: +1.523 | 0.909 | 0.5594 | -0.3496 | MOVED |
| 124 | momentum capture range, low: +0.089 | -0.503 | -0.4627 | 0.04028 | MOVED |
| 128 | three of the four ratios above 1.0 sit on the four thinnest denominators | 3 | 1 | -2 | MOVED |
| 133 | momentum vs mean_reversion: 7-5 | 9-3 | 12-0 | - | MOVED |
| 133 | p = 0.77 | 0.15 | 0.000488 | -0.1495 | MOVED |
| 143 | mean-reversion's one win is barely above 1.0: capture 1.004 | 1.52 | 1.677 | 0.1572 | MOVED |
| 143 | mean-reversion +0.160 | 0.783 | 0.9925 | 0.2095 | MOVED |
| 170 | the identical test over seeds 12-23: momentum over mean-reversion 9-3 | 10-2 | 11-1 | - | MOVED |
| 170 | p = 0.15 | 0.04 | 0.006348 | -0.03365 | MOVED |
| 181 | three days, seeds 0-9: the reference's per-seed P&L spans $11.2k... | 13,700 | 15,969 | 2,269 | MOVED |
| 182 | against a pooled +0.44 across the ten | 0.78 | 0.7118 | -0.06824 | MOVED |
| 182 | mean-reversion's ratio on the thinnest of those markets: +1.29 | 1.57 | 2.077 | 0.5067 | MOVED |
| 187 | averaging the ten ratios instead of pooling them would move the verdict to +0.61 | 0.88 | 0.7824 | -0.09763 | MOVED |

### docs/an-llm-agent.md

| line | figure | published | measured | delta | status |
|---|---|---|---|---|---|
| 30 | oracle pnl 229751 | 155,707 | 173,306 | 17,599 | MOVED |
| 30 | oracle why-right 100% | 100 | 100 | 0 | reproduced |
| 32 | momentum why-right prints '-' (no explain()) | True | True | - | structural_ok |
| 32 | momentum pnl 21520 | -2,207 | -32,064 | -29,857 | MOVED |
| 50 | momentum's twenty-day impact flips sign the same way | - | True | - | info |
| 52 | over two days both agents are positive in 12 of 12 | 12 | 11 | -1 | MOVED |
| 60 | positive in only 7 of 12 seeds | 5 | 6 | 1 | MOVED |
| 60 | by day three the oracle's sign already belongs to the seed: positive in 8 of 12 | 11 | 12 | 1 | MOVED |
| 63 | ...to +470 bps across seeds 2020-2031 | 418.4 | 559.1 | 140.7 | MOVED |
| 63 | oracle twenty-day impact spans -235... | -451.1 | -421.6 | 29.53 | MOVED |
| 106 | steps_per_day defaults to 6 | 6 | 6 | 0 | reproduced |
| 109 | driver is one of the engine's seven factors | 9 | 9 | 0 | reproduced |
...
| 62 | vix takes a new value every day: 120 distinct values in 120 days | 118 | 120 | 2 | MOVED |
...
| 81 | pinning federal_funds_rate alone repriced none of the twenty | 0 | 19 | 19 | MOVED |

### docs/forking-a-simulation.md

| line | figure | published | measured | delta | status |
|---|---|---|---|---|---|
| 22 | pt.branch cost < 1 ms | 1 | 5.053 | 4.053 | MOVED |
| 23 | Checkpoint.resume() cost 2.7 s | 2.7 | 0.2759 | -2.424 | machine_bound |
| 26 | Checkpoint replay is three orders of magnitude slower than branch | 3 | 1.737 | -1.263 | MOVED |

### docs/ground-truth.md

| line | figure | published | measured | delta | status |
|---|---|---|---|---|---|
| 19 | factors sum to change in mispricing_s, residual around 1e-16 | 1e-16 | 1.49e-17 | - | reproduced |
...
| 215 | the leverage sign is stable: negative in six seeds of six | - | False | - | info |
...
| line | figure | published | measured | delta | status |
|---|---|---|---|---|---|
| 92 | a nudged garch_alpha fingerprints as custom-7f290e34, never pt-v1 | custom-7f290e34 | custom-9f6e67b6 | - | MOVED |
...
| line | figure | published | measured | delta | status |
|---|---|---|---|---|---|
| 14 | 252 days x 10 instruments: 2.9 s | 2.9 | 1.216 | -1.684 | machine_bound |
| 15 | 252 days x 100 instruments: 27.4 s | 27.4 | 10.8 | -16.6 | machine_bound |
| 16 | 252 x 100 recording 9.8M rows: 28.2 s | 28.2 | 10.8 | -17.4 | machine_bound |
| 16 | a recorded year at 100 instruments is 9.8M rows | 9,828,000 | 9,828,000 | 0 | reproduced |
| 17 | 8 seeds x 21 days x 100, serial: 20.0 s | 20 | 7.219 | -12.78 | machine_bound |
| 18 | 8 seeds x 21 days x 100, 8 workers: 6.1 s | 6.1 | 0.9742 | -5.126 | machine_bound |
| 20 | recording a full year of tick-grain ground truth costs a few percent at most (bound) | 4 | -0.1478 | -4.148 | reproduced |
| 24 | nearly half the pairs came out negative | 0.5 | 0.75 | 0.25 | reproduced |
| 24 | the median was about +1% | 1 | -0.1478 | -1.148 | reproduced |
| 25 | the 0.8s between the two 252x100 rows is run-to-run noise | 0.8 | 0.8 | 6.66e-16 | reproduced |
| 28 | sweeps parallelise about 3.3x on eight cores | 3.3 | 7.411 | 4.111 | machine_bound |
| 32 | cost scales roughly linearly in instruments x days (t100/t10 ~ 9.4 published) | 9.45 | 8.882 | -0.5678 | reproduced |
...
| 35 | recording ground truth costs a few percent at most (bound) | 4 | -0.1478 | -4.148 | reproduced |
...
| line | figure | published | measured | delta | status |
|---|---|---|---|---|---|
| 36 | pt.version() == '0.1.0' | 0.3.0 | 0.6.1 | - | MOVED |
| 37 | model_preset()['name'] == 'pt-v1' | pt-v12 | pt-v16 | - | MOVED |
...
| 212 | 'the identical known-answer v11 digest' - the era named as current | 11 | 13 | 2 | MOVED |
| 215 | the digest the five targets reported at f722ce3, printed in full | 60d475726c8b270df0894da7577523e98d044dd09afc6b536377eaf4b40de590 | 74f451bb1e3372ca032f57b9546ddf40a51e08c8fc7dab82a17e73a3d7749f39 | - | MOVED |
...
| 37 | the era's later model changes have since taken the known-answer version to 11 | 11 | 13 | 2 | MOVED |
...
| 164 | state_snapshot()['rng'] is twenty-one numbers, three per stream | 21 | 21 | 0 | reproduced |
...
| line | figure | published | measured | delta | status |
|---|---|---|---|---|---|
| 30 | buy_and_hold calm return | -6.08 | -8.97 | -2.89 | MOVED |
| 30 | buy_and_hold delta | -2.56 | -3.433 | -0.8726 | MOVED |
| 30 | buy_and_hold hiked return | -8.64 | -12.4 | -3.762 | MOVED |
| 31 | momentum calm return | -5.64 | -6.071 | -0.4312 | MOVED |
| 31 | momentum delta | -1.87 | -4.324 | -2.454 | MOVED |
| 31 | momentum hiked return | -7.51 | -10.4 | -2.885 | MOVED |
| 32 | oracle calm return | 13.22 | 12.01 | -1.211 | MOVED |
| 32 | oracle delta | -2.11 | -2.628 | -0.5177 | MOVED |
| 32 | oracle hiked return | 11.11 | 9.382 | -1.728 | MOVED |
| 35 | and never escapes | 0 | 0 | 0 | reproduced |
| 36 | on one seed in five it trades around the shock entirely | 1 | 1 | 0 | reproduced |
| 40 | ...to -3.4 | -2.6 | -3.313 | -0.7127 | MOVED |
| 40 | across sim seeds 5 to 9 buy-and-hold gives up 3.4 to 4.7 points (delta -4.7...) | -3.9 | -3.709 | 0.1912 | MOVED |
| 41 | pinning federal_funds_rate alone: exactly 0.00% across twenty instruments over 40 days | 0 | 4.094 | 4.094 | MOVED |
| 41 | ...to +0.5 | 1.2 | 1.079 | -0.1205 | MOVED |
| 41 | momentum's give-up spans -5.1... | -1.9 | -4.33 | -2.43 | MOVED |
| 47 | a 60-day run crossing the day-45 central-bank meeting reprices a median -4.29% | -4 | -5.685 | -1.685 | MOVED |
...
| 156 | annualised realised vol at VIX 5 | 30.29 | 24.04 | -6.251 | MOVED |
| 157 | annualised realised vol at VIX 15 | 36.71 | 28.35 | -8.356 | MOVED |
| 158 | annualised realised vol at VIX 45 | 112.1 | 83.66 | -28.44 | MOVED |
| 159 | annualised realised vol at VIX 65 | 135.5 | 119.4 | -16.1 | MOVED |
| 161 | a thirteenfold move in VIX moves realised volatility by a factor of 2.5 | 4.5 | 4.968 | 0.4677 | MOVED |
| 188 | mean quoted spread at VIX 15 | 11.78 | 11.85 | 0.07323 | MOVED |
| 188 | mean quoted spread at VIX 25 | 14.14 | 14.33 | 0.19 | MOVED |
| 188 | mean quoted spread at VIX 45 | 17.49 | 19.61 | 2.119 | MOVED |
| 189 | mean quoted spread at VIX 65 | 22.62 | 27.19 | 4.569 | MOVED |
| 195 | mean pairwise correlation at VIX 15, 300 pairs | 0.197 | 0.2905 | 0.09351 | MOVED |
| 195 | mean pairwise correlation at VIX 45 | 0.626 | 0.5992 | -0.02676 | MOVED |
| 195 | mean pairwise correlation at VIX 65 | 0.678 | 0.6623 | -0.01573 | MOVED |
...
| 91 | pt.version() stayed '0.1.0' across the era boundary | 0.3.0 | 0.6.1 | - | MOVED |
...
| 156 | the rebalance measurement swings the same one-day signal from +37.55% at three decisions a day... | 37.55 | 40.38 | 2.831 | MOVED |
| 156 | ...to -27.46% at twelve, purely by trading it more often | -27.46 | -29.1 | -1.639 | MOVED |
| 156 | ...to +9.79% at six... | 9.79 | 6.07 | -3.72 | MOVED |
...
| 33 | the round trip ends anywhere between -17.72... | -17.72 | -25.71 | -7.991 | MOVED |
| 34 | ...and +2.03 bps | 2.03 | -4.76 | -6.79 | MOVED |
| 34 | negative on seven of the eight | 7 | 8 | 1 | MOVED |
| 35 | the round trip's median across the eight published seeds: -12.40 bps | -12.4 | -14.87 | -2.466 | within_seed_variation |
...
| 65 | all three it never touched moved | 3 | 5 | 2 | MOVED |
| 65 | the agent traded 57 names | 57 | 50 | -7 | MOVED |
| 65 | leaving three untouched | 3 | 10 | 7 | MOVED |
| 66 | against a 9.71 bps median direct impact on the traded names | 9.71 | 9.851 | 0.1408 | MOVED |
| 66 | ...+2.00 and +1.97 bps | 2 | 6.146 | 4.146 | MOVED |
| 66 | by -10.72... | -10.72 | -13.24 | -2.521 | MOVED |
| 66 | the third leaked name: +1.97 bps | 1.97 | 2.882 | 0.9123 | MOVED |
| 79 | at one and two days untouched_moved() is still empty | True | True | - | structural_ok |
| 81 | nothing leaks at one or two days; nine untouched names leak at three | 9 | 7 | -2 | MOVED |
| 82 | at four days eighteen untouched names move | 18 | 11 | -7 | MOVED |
...
- **llm.mom_imp20_flips** (docs/an-llm-agent.md:50): Retired 2026-08-28 at 0.4.0. docs/an-llm-agent.md now says a twenty-day impact figure has whatever sign the seed hands it, which is the opposite of what this row asserts. The row read structural_fail at 0.2.0, structural_ok at 0.3.0 and structural_fail again here: a claim that flips with the preset is not a stable published fact.
- **llm.imp3_oracle_pos** (docs/an-llm-agent.md:60): re-keyed from llm.imp3_all_pos (both agents 12 of 12 at three days), which PR 26's re-measurement retired: three days no longer reads clean
...
- **realism.leverage_sign_stable** (docs/how-realistic-is-this-market.md:215): Retired 2026-08-28 at 0.4.0. The docs rewrite removed this sentence: docs/how-realistic-is-this-market.md no longer claims the leverage sign is stable across the six realism seeds, so there is no published figure to grade. The underlying measurement did move (pt-v12 negative in 6 of 6 seeds 1-6, pt-v14 in 5 of 6, one seed at +0.0013), and at thirty seeds both presets have positive seeds (4 of 30 and 6 of 30) with medians inside the -0.16 to 0.0 band. The claim was a fragile n=6, not a property of the model.
