...
BUCKET=s3://dia-test-101631415962-us-east-2-an/pretium-calib/out/fearscreen2
...
python tools/calibration/fear_screen.py     --grid ext --workers WORKERS_PLACEHOLDER     --out /home/ec2-user/out/fear-screen2.json || true
aws s3 cp /home/ec2-user/out/fear-screen2.json "BUCKET_PLACEHOLDER/" || true
