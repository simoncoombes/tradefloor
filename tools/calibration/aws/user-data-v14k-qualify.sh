...
BUCKET=s3://dia-test-101631415962-us-east-2-an/pretium-calib/out/v14k-qualify
...
if ! aws s3 cp "s3://dia-test-101631415962-us-east-2-an/pretium-calib/in/cands-v14k.json" \
...
for spec in "v12:" "sf94:market_vol_alpha=0.28035004,market_vol_beta=0.69244622,jump_intensity_idio=0.0068895346,jump_sigma_idio=0.08745117,jump_intensity_market=0.0565753337,jump_vix_coupling=0.2626,idio_sigma_scale=0.59604441,garch_vix_coupling=0.14219611,crisis_vix_threshold=30.88325108,crisis_blend_gain=0.8275881,sector_factor_sigma=0.0099802949,sector_loading=0.58821442,mispricing_half_life_days=68.25733542,market_vol_vix_anchor=15.98426471,endogenous_news_sigma=0.020360516"; do
  name="${spec%%:*}"; ov="${spec#*:}"
...
for spec in "v12::" "sf94:pt-v12:market_vol_alpha=0.28035004,market_vol_beta=0.69244622,jump_intensity_idio=0.0068895346,jump_sigma_idio=0.08745117,jump_intensity_market=0.0565753337,jump_vix_coupling=0.2626,idio_sigma_scale=0.59604441,garch_vix_coupling=0.14219611,crisis_vix_threshold=30.88325108,crisis_blend_gain=0.8275881,sector_factor_sigma=0.0099802949,sector_loading=0.58821442,mispricing_half_life_days=68.25733542,market_vol_vix_anchor=15.98426471,endogenous_news_sigma=0.020360516"; do
...
if [ -f /home/ec2-user/out/s8-sf94.txt ] && [ -f /home/ec2-user/out/roster-sf94.json ]; then
