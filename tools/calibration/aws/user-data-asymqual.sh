...
BUCKET=s3://dia-test-101631415962-us-east-2-an/pretium-calib/out/asymqual
...
if ! aws s3 cp "s3://dia-test-101631415962-us-east-2-an/pretium-calib/in/cands-asymqual.json" \
...
# asymqual: the full-house qualification. asymgrid's vc85m1s7 passes
# every band on the screening blocks with zero damage and margins of
# 0.0022 (1201) and 0.0012 (co401) -- resolution-thin. Thirteen blocks
# judge the candidate and two neighbours (more mbda + more slbeta
# funding; gentler vixcyc). The winner needs the full card: 13/13
# full-house INCLUDING corr_asymmetry, both crisis instruments held,
# and the driven cost (~+0.013) stated.
#
