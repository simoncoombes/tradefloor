...
BUCKET=s3://dia-test-101631415962-us-east-2-an/pretium-calib/out/flowcard2
...
if ! aws s3 cp "s3://dia-test-101631415962-us-east-2-an/pretium-calib/in/cands-flowcard2.json" \
...
for BLOCK in 201 401 701 1201; do
