...
BUCKET=s3://dia-test-101631415962-us-east-2-an/pretium-calib/out/frontier2
...
if ! aws s3 cp "s3://dia-test-101631415962-us-east-2-an/pretium-calib/in/cands-frontier2.json" \
