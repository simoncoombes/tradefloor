...
BUCKET=s3://dia-test-101631415962-us-east-2-an/pretium-calib/out/fearbasket
...
python tools/calibration/fear_basket.py     --roster /home/ec2-user/roster.json     --workers WORKERS_PLACEHOLDER     --out /home/ec2-user/out/fear-basket.json || true
aws s3 cp /home/ec2-user/out/fear-basket.json "BUCKET_PLACEHOLDER/" || true
