...
BUCKET=s3://dia-test-101631415962-us-east-2-an/pretium-calib/out/fearjumpstats
...
python tools/calibration/fear_screen.py     --grid jump --workers WORKERS_PLACEHOLDER     --out /home/ec2-user/out/fear-screen.json || true
