...
BUCKET=s3://dia-test-101631415962-us-east-2-an/pretium-calib/out/u222card
...
if ! aws s3 cp "s3://dia-test-101631415962-us-east-2-an/pretium-calib/in/cands-u222.json" \
...
export PT_UNIVERSE_SEED=222
export PT_UNIVERSE_N=40
...
for BLOCK in 1801 1901 2001 2101 2201 2301 2401 2501 2601 2701; do
  python tools/calibration/gate_batch.py \
    --candidates /home/ec2-user/candidates.json \
    --seeds 100 --seed-start "$BLOCK" \
...
if [ -f /home/ec2-user/out/gates-2701.json ] && [ -f /home/ec2-user/out/gates-1801.json ]; then
