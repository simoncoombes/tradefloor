...
BUCKET=s3://dia-test-101631415962-us-east-2-an/pretium-calib/out/rnd14-confirm
...
# Round 13's screen put d3-f85 ahead of d3-f10 on block 201: 14/14 at both
# horizons and on the held-out roster with all four walls held, against
# d3-f10's 13/14 at 504 on volatility. One block and 28 vectors is a screen,
# and the top of a 28-vector screen on one block is exactly the kind of
# result this project has been fooled by before, so this runs the four
# blocks the screen did not use.
...
if [ -f /home/ec2-user/out/gates-train.json ] \
   ...
   && [ -f /home/ec2-user/out/gates-501.json ]; then
