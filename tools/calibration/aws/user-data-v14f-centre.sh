...
BUCKET=s3://dia-test-101631415962-us-east-2-an/pretium-calib/out/v14f-centre
...
for BLOCK in "--seed-start 1401" "--seed-start 701" "--seed-start 201" \
  ...
  aws s3 cp "/home/ec2-user/out/gates-${TAG}.json" "$BUCKET/" || true
done
