...
BUCKET=s3://dia-test-101631415962-us-east-2-an/pretium-calib/out/fearwirestats
...
python tools/calibration/fear_screen.py     --grid wire --workers WORKERS_PLACEHOLDER     --out /home/ec2-user/out/fear-screen.json || true
aws s3 cp /home/ec2-user/out/fear-screen.json "BUCKET_PLACEHOLDER/" || true
