...
BUCKET=s3://dia-test-101631415962-us-east-2-an/pretium-calib/out/volscreen
...
WORKERS=30   # c8g.24xlarge alongside round 33
...
if ! aws s3 cp "s3://dia-test-101631415962-us-east-2-an/pretium-calib/in/cands-volscreen.json" \
...
if [ -f /home/ec2-user/out/gates-2701.json ] && [ -f /home/ec2-user/out/gates-2701.json ]; then
