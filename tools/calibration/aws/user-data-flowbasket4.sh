...
BUCKET=s3://dia-test-101631415962-us-east-2-an/pretium-calib/out/flowbasket4
...
FLOW_GRID=four python tools/calibration/flow_basket.py     --roster /home/ec2-user/roster.json     --workers WORKERS_PLACEHOLDER     --out /home/ec2-user/out/flow-basket4.json || true
aws s3 cp /home/ec2-user/out/flow-basket4.json "BUCKET_PLACEHOLDER/" || true
