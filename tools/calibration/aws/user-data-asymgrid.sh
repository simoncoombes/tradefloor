...
# asymgrid: the composition round. The down-transmission dial hits the
# corr_asymmetry target dead-on but costs co-movement at 401 nearly 1:1,
# and 401 holds by 0.0018. vixcyc is clean but 0.006 short at 1201.
# sector loading 0.7 funds +0.0023 of co401. Ten cells search the
# affordable frontier: vixcyc {0.70, 0.85} x mbda {0, .01, .02} x
# slbeta {0.5, 0.7}, on the failing blocks plus both crisis binders.
#
