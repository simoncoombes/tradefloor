...
BUCKET=s3://dia-test-101631415962-us-east-2-an/pretium-calib/out/hosweep
...
python tools/calibration/ho_sweep.py     --roster /home/ec2-user/roster.json     --workers WORKERS_PLACEHOLDER     --out /home/ec2-user/out/ho-sweep.json || true
aws s3 cp /home/ec2-user/out/ho-sweep.json "BUCKET_PLACEHOLDER/" || true
