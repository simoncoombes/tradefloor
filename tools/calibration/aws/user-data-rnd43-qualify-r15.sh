...
BUCKET=s3://dia-test-101631415962-us-east-2-an/pretium-calib/out/rnd43-qualify-r15
...
if ! aws s3 cp "s3://dia-test-101631415962-us-east-2-an/pretium-calib/in/cands-rnd43.json" \
...
for spec in "v12:" \
            "r15-70:market_vol_alpha=0.300730582,market_vol_beta=0.66999041,jump_intensity_idio=0.0068895346,jump_sigma_idio=0.08369236,jump_intensity_market=0.0565753337,jump_vix_coupling=0.2626,idio_sigma_scale=0.5688,garch_vix_coupling=0.0269,crisis_vix_threshold=30.88325108,crisis_blend_gain=0.8275881,sector_factor_sigma=0.01006215,sector_loading=0.57351027,mispricing_half_life_days=68.25733542,market_vol_vix_anchor=15.98426471,endogenous_news_sigma=0.021" \
            "r15-86:market_vol_alpha=0.300730582,market_vol_beta=0.66999041,jump_intensity_idio=0.0068895346,jump_sigma_idio=0.08369236,jump_intensity_market=0.0565753337,jump_vix_coupling=0.2626,idio_sigma_scale=0.5688,garch_vix_coupling=0.0269,crisis_vix_threshold=30.88325108,crisis_blend_gain=0.8275881,sector_factor_sigma=0.01006215,sector_loading=0.57351027,mispricing_half_life_days=68.25733542,market_vol_vix_anchor=15.98426471,endogenous_news_sigma=0.0258"; do
  name="${spec%%:*}"; ov="${spec#*:}"
...
for spec in "v12:::" \
            "r15-70:pt-v12:market_vol_alpha=0.300730582,market_vol_beta=0.66999041,jump_intensity_idio=0.0068895346,jump_sigma_idio=0.08369236,jump_intensity_market=0.0565753337,jump_vix_coupling=0.2626,idio_sigma_scale=0.5688,garch_vix_coupling=0.0269,crisis_vix_threshold=30.88325108,crisis_blend_gain=0.8275881,sector_factor_sigma=0.01006215,sector_loading=0.57351027,mispricing_half_life_days=68.25733542,market_vol_vix_anchor=15.98426471,endogenous_news_sigma=0.021" \
            "r15-86:pt-v12:market_vol_alpha=0.300730582,market_vol_beta=0.66999041,jump_intensity_idio=0.0068895346,jump_sigma_idio=0.08369236,jump_intensity_market=0.0565753337,jump_vix_coupling=0.2626,idio_sigma_scale=0.5688,garch_vix_coupling=0.0269,crisis_vix_threshold=30.88325108,crisis_blend_gain=0.8275881,sector_factor_sigma=0.01006215,sector_loading=0.57351027,mispricing_half_life_days=68.25733542,market_vol_vix_anchor=15.98426471,endogenous_news_sigma=0.0258"; do
...
if [ -f /home/ec2-user/out/s8-v12.txt ] && [ -f /home/ec2-user/out/roster-r15-70.json ]; then
