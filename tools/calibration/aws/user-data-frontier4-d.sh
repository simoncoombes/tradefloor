...
BUCKET=s3://dia-test-101631415962-us-east-2-an/pretium-calib/out/frontier4
...
if ! aws s3 cp "s3://dia-test-101631415962-us-east-2-an/pretium-calib/in/cands-frontier4.json" \
...
if [ -f /home/ec2-user/out/gates-1201.json ] && [ -f /home/ec2-user/out/gates-1201.json ]; then
