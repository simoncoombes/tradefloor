...
BUCKET=s3://dia-test-101631415962-us-east-2-an/pretium-calib/out/qual26
...
if ! aws s3 cp "s3://dia-test-101631415962-us-east-2-an/pretium-calib/in/cands-qual26.json" \
...
for BLOCK in 201 301 401 501 601 701 801 901 1001 1101 1201 1301 1401 1501 1601 1701 1801 1901 2001 2101 2201 2301 2401 2501 2601 2701; do
...
if [ -f /home/ec2-user/out/gates-2701.json ] && [ -f /home/ec2-user/out/gates-201.json ]; then
